...
void read_testIOGenEvent(std::ostream & os)
{
    ...
    const char infile[] = "/Users/thomasgriffiths/Documents/Projects/Physics/UE-Phys-DA&ML/S2/GeantExample3/HEPmc/HepMC-2.06.11/test/testIOGenEvent.input";
...
void read_variousFormats(std::ostream & os)
{
    ...
    const char infile[] = "/Users/thomasgriffiths/Documents/Projects/Physics/UE-Phys-DA&ML/S2/GeantExample3/HEPmc/HepMC-2.06.11/test/testHepMCVarious.input";
    std::ifstream is( infile );
    if( !is ) {
      std::cerr << "cannot open " << infile << std::endl;
      exit(-1);
