...
int main() { 
	...
	HepMC::IO_GenEvent ascii_in2("/Users/thomasgriffiths/Documents/Projects/Physics/UE-Phys-DA&ML/S2/GeantExample3/HEPmc/HepMC-2.06.11/test/testHepMCVarious.input",std::ios::in);
